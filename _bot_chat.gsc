	...
	switch ( level.gametype )
	{
		case "war":
			switch ( randomint( 3 ) )
			{
				...
				case 3:
					self BotDoChat( 7, "Hope this game goes fast, my wife is waiting" );
					break;
					
				case 4:
					self BotDoChat( 7, "Let's kick some ass and dominate this match!" );
					break;
					
				case 5:
					self BotDoChat( 7, "Time to show these guys who runs this battlefield!" );
					break;
					
				case 6:
					self BotDoChat( 7, "They won't know what hit them—let's do this!" );
					break;
			}
		...
		case "dom":
			switch ( randomint( 3 ) )
			{
				...
				case 2:
					self BotDoChat( 7, "Time to get my nuke!" );
					break;
					
				case 3:
					self BotDoChat( 7, "Secure the objectives, and make sure they don’t get shit back." );
					break;
			}
	...
	if ( level.teambased )
	{
		...
		if ( self.pers[ "team" ] == winningteam )
		{
			switch ( randomint( 21 ) )
			{
				...
				case 16:
					self BotDoChat( 20, "lol the pussies got pwnd :3" );
					break;
				...
				case 17:
					...
					{
						self BotDoChat( 20, "damn i sucked but i still won, thanks team!" );
					}
				...
				case 18:
					...
					{
						self BotDoChat( 20, "lol my team is good, i was a shitty player this match tho" );
					}
					else if ( self != loser && randomint( 2 ) == 1 )
					{
			...
			if ( winningteam != "none" )
			{
				switch ( randomint( 21 ) )
				{
					...
					case 15:
						if ( self == winner )
						{
							self BotDoChat( 20, "my teammates are fucking garabge" );
						}
						else if ( self == loser )
						{
					...
					case 19:
						self BotDoChat( 20, "did we lose? WTF!" );
						break;
...
bot_onnukecall_watch()
{
	...
	switch ( randomint( 4 ) )
	{
		case 0:
			...
			{
				self BotDoChat( 30, "Wow just end the game why dont you, asshat" );
			}
			else
			{
		...
		case 2:
			self BotDoChat( 30, "Wow, that nuke is seriously impressive." );
			break;
...
bot_chat_killed_watch( victim )
{
	...
	switch ( randomint( 42 ) )
	{
		...
		case 26:
			message = ( "lol wtf that was a funny death" );
			break;
		...
		case 29:
			message = ( "lol wat was that " + victim.name + "?" );
			break;
...
bot_chat_death_watch( killer, last_ks )
{
	...
	switch ( randomint( 68 ) )
	{
		...
		case 2:
			message = ( "^" + ( randomint( 6 ) + 1 ) + "WOW nice shot " + killer.name );
			break;
		...
		case 21:
			message = ( killer.name + " You lag switcher!!" );
			break;
		...
		case 41:
			message = ( "lol  wtf was that " + killer.name + "?" );
			break;
		...
		case 66:
			message = ( "you are banned " + killer.name + "!!" );
			break;
			
		case 67:
			message = ( "that was complete shit " + killer.name );
			break;
	}
...
bot_chat_killcam_watch( state, b, c, d, e, f, g )
{
	...
	switch ( state )
	{
		case "start":
			...
			{
				case 0:
					self BotDoChat( 1, "WTF?!?!?!! Dude youre a hacker and a half of a dick!!" );
					break;
		...
		case "stop":
			switch ( randomint( 2 ) )
			{
				...
				case 1:
					self BotDoChat( 1, "Got it recorded, Loser" );
					break;
			}
			...
			switch ( streakName )
			{
				...
				case "nuke":
					switch ( randomint( 8 ) )
					{
						...
						case 4:
							self BotDoChat( 100, "sweet I get a nuke and my team are completely shit" );
							break;
						...
						case 7:
							self BotDoChat( 100, "Get nuked pussies!" );
							break;
					}
...
bot_chat_crate_cap_watch( state, aircare, player, d, e, f, g )
{
	...
	switch ( state )
	{
		...
		case "stop":
			if ( !isdefined( aircare.owner ) || aircare.owner == self )
			{
				switch ( randomint( 6 ) )
				{
					...
					case 1:
						self BotDoChat( 10, "lol noobs i got my carepackage. what now!?" );
						break;
			...
			else
			{
				switch ( randomint( 5 ) )
				{
					...
					case 1:
						self BotDoChat( 10, "lol sweet just found a carepackage, just for me!" );
						break;
		...
		case "unreachable":
			...
			{
				case 0:
					self BotDoChat( 25, "damnit that carepackage was terribly placed man" );
					break;
			}
	...
	switch ( state )
	{
		case "start":
			switch ( randomint( 14 ) )
			{
				...
				case 1:
					self BotDoChat( 10, "im taking down this fucking killstreak" );
					break;
				...
				case 4:
					self BotDoChat( 10, "killstreaks suck assssss" );
					break;
...
bot_chat_camp_watch( state, wp, time, d, e, f, g )
{
	...
	switch ( state )
	{
		case "go":
			...
			{
				case 0:
					self BotDoChat( 10, "im thinking of going to camp for " + time + " mins " );
					break;
				...
				case 2:
					self BotDoChat( 10, "fuck this im going to camp" );
					break;
			}
...
bot_chat_follow_watch( state, player, time, d, e, f, g )
{
	...
	switch ( state )
	{
		case "start":
			...
			{
				case 0:
					self BotDoChat( 10, "well im going to follow " + player.name + " for " + time + " or til he dies" );
					break;
				...
				case 2:
					self BotDoChat( 10, "lets be battle buddies " + player.name + " and ill follow you!" );
					break;
			}
		...
		case "stop":
			...
			{
				case 0:
					self BotDoChat( 10, "well that was fun following " + player.name + " for " + time + " seconds til he died" );
					break;
					
				case 1:
					self BotDoChat( 10, "im done following this idiot" );
					break;
			}
	...
	switch ( state )
	{
		case "start":
			switch ( randomint( 5 ) )
			{
				...
				case 1:
					self BotDoChat( 80, "FUCK THIIISSS! I'm out." );
					break;
				...
				case 4:
					self BotDoChat( 80, "K thx fucking hackers" );
					break;
			}
...
bot_chat_revenge_watch( state, loc, killer, d, e, f, g )
{
	...
	switch ( state )
	{
		case "start":
			...
			{
				case 0:
					self BotDoChat( 10, "im going to kill these motherfuckers..redemption time!" );
					break;
			}
		...
		case "stop":
			...
			{
				case 0:
					self BotDoChat( 10, "my redemption isnt going as planned" );
					break;
			}
